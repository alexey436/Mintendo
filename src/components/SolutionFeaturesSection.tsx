      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 lg:gap-8">
          {SOLUTION_FEATURES_DATA.map((feat, idx) => (
            <ScrollReveal key={feat.id} direction="up" delay={idx * 0.04}>
              <SpotlightCard feature={feat} icon={icons[idx]} />
            </ScrollReveal>
          ))}
        </div>
        ...
        <ScrollReveal direction="up" delay={0.08}>
          <div className="mt-10 sm:mt-14 p-5 sm:p-6 rounded-2xl bg-slate-900/90 border border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6">

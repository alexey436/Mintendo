...
export const FaqSection: React.FC<FaqSectionProps> = ({ onOpenConsultation }) => {
  ...
  return (
    <section id="faq" className="py-20 md:py-28 bg-[#0B0F19] relative border-t border-slate-800">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-slate-300 text-base sm:text-lg">
            Жодних розмитих формулювань. Ми за повну прозорість ще до підписання договору.
          </p>
        </div>
        ...
        <div className="mt-12 p-6 rounded-2xl bg-gradient-to-r from-slate-900 via-slate-800/80 to-slate-900 border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
